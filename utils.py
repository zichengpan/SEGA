...
def get_optimizer_inc(trainable_params, args, epoch=None, milestone=None):

    optimizer = torch.optim.SGD(trainable_params, args.lr_base, momentum=0.9, nesterov=True,
                                weight_decay=args.decay)
